        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="news" role="tabpanel">
...
<script type="text/javascript">
   $(document).ready(function() {
     ...
     $(".pagination_legalNews").bootpag({
       ...
       e.preventDefault();
       $("#result_legalNews").prepend('<div class="loading-indication" style="width: 25px;height: 25px"><img src="assets/img/ajax-loader.gif" /> Loading...</div>');
