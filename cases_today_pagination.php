      ...
      <!-- <table id="example" class="table table-bordered"> -->
         <thead>
            ...
            $string_query = "";
              ...
              if(!isset($_SESSION['cases_today_pagination_page'])){
                $_SESSION['cases_today_pagination_page'] = 1;
              }
              ...
              $qry_cases = "SELECT lawyer_id,case_id, next_date, judge_name, stage, court_number, case_number, party_a, party_b, court_name, client_name, category, file_no, client_phone, client_email FROM tbl_cases WHERE (".$cases_id."next_date = '".date('Y-m-d')."') AND lawyer_id  IN (".$lawyer_id.") ".$string_query." ORDER BY CASE 
              ...
              $get_total_rows_today = mysqli_num_rows($select_cases); 
              $pages_today = ceil($get_total_rows_today/$item_per_page);
              ?>
              <input type="hidden" id="total_cases_available_today" value="<?php echo $get_total_rows_today; ?>"></input>
