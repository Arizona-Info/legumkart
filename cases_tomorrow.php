   ...
   <div class="table-responsive action_table">
      <table id="attendenceDetailedTable1" class="display responsive nowrap" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            $next_qry = "SELECT MAX(nextdt_id) AS nextdt_id, next_case_id, next_case_date, next_stage, next_judge, prev_case_date, lawyer_id FROM tbl_case_nextdt WHERE lawyer_id IN (".$lawyer_id.") AND next_case_date = '".date('Y-m-d', strtotime('+1 day'))."' GROUP BY next_case_id";
            ...
            $qry_cases = "SELECT lawyer_id,case_id, next_date, judge_name, stage, court_number, case_number, party_a, party_b, court_name, client_name, category, file_no, client_phone, client_email FROM tbl_cases WHERE (".$cases_id."next_date = '".date('Y-m-d', strtotime('+1 day'))."') AND lawyer_id IN (".$lawyer_id.") ORDER BY CASE 
            ...
            // $tomorrow_count = mysqli_num_rows($select_cases);
          ...
          <tr>
            ...
            <td><u><a href="#court_detailsc<?php echo $select_cases_result['case_id'];?>"  data-toggle="modal" title="Court Details"><?php echo $select_cases_result['court_name'];?></a></u></td>
            ...
            <td><u><a href="#client_detailsc<?php echo $select_cases_result['case_id'];?>"  data-toggle="modal" title="Client Details"><?php echo $select_cases_result['client_name'];?></a></u></td>                  
               ...
               <div class="action_btn">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="actionDropdown">
                     ...
                     <?php
                        ...
                        ?>
                     <li>
                        <a href="#delete_casesc<?php echo $select_cases_result['case_id'];?>" class="btn btn_sm1" data-toggle="modal" title="Delete"><i class="fa fa-trash"></i> Delete</a>
                     </li>
                     <?php } ?>
                  </ul>
               </div>
...
<div class="zind modal fade" id="court_detailsc<?php echo $select_cases_result['case_id'];?>">
...
<div class="zind modal fade" id="client_detailsc<?php echo $select_cases_result['case_id'];?>">
   <div class="modal-dialog">
      <div class="modal-content">
         <a href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-close"></i></a>
         <div class="modal-header">
      ...
      ?>
      <!-- Delete Cases -->
         <div class="zind modal fade" id="delete_casesc<?php echo $select_cases_result['case_id'];?>">
            <div class="modal-dialog">
               <div class="modal-content">
                  <a href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-close"></i></a>
                  <div class="modal-header">
