...
$proplist = mysqli_query($conn,"SELECT t2.email, t2.firm_name, t2.lawyer_id, t2.type, t2.firm_id, t2.phone from tbl_cases t1, tbl_lawyers t2 where t1.next_date= date_add(CURDATE(),INTERVAL 1 DAY) AND t1.lawyer_id=t2.lawyer_id");
    ...
    if($proprow['type'] == 'firm' OR $proprow['firm_id'] != 0)
        {  
            ...
            if ((!in_array($lawyerid,$arry_ids, TRUE) AND !in_array($lawyerid,$arr_singleid, TRUE)))
            {
              ...
              $proplisted_lawyers = mysqli_query($conn,"SELECT lawyer_id,email,phone from tbl_lawyers where firm_id='".$firmidd."' OR lawyer_id='".$firmidd."'");
             ...
             $prop = "SELECT t1.court_name, t1.court_number, t1.case_number, t1.client_name, t1.next_date, t2.email, t2.phone, t2.firm_name, t2.lawyer_id, t2.type, t2.firm_id FROM tbl_cases t1, tbl_lawyers t2  WHERE t1.lawyer_id=t2.lawyer_id AND t1.lawyer_id IN ($lawyers_list) AND t1.next_date= date_add(CURDATE(),INTERVAL 1 DAY)";
        ...
        if ((!in_array($lawyerid,$arry_ids, TRUE) AND !in_array($lawyerid,$arr_singleid, TRUE)))
            ...
            $propg = "SELECT t1.court_name, t1.court_number, t1.case_number, t1.client_name, t1.next_date, t2.email, t2.phone, t2.firm_name, t2.lawyer_id, t2.type, t2.firm_id FROM tbl_cases t1, tbl_lawyers t2  WHERE t1.lawyer_id=t2.lawyer_id AND t1.lawyer_id ='".$lawyerid."'  AND t1.next_date= date_add(CURDATE(),INTERVAL 1 DAY)";
        ...
        //send sms for cases
        // sendtransactionsms($phone_list,$message); 
        

    }
  } 

$propnxtdt = mysqli_query($conn,"SELECT t3.email, t3.firm_name, t3.lawyer_id, t3.type, t3.firm_id, t3.phone from tbl_cases t1, tbl_case_nextdt t2, tbl_lawyers t3 where t1.case_id=t2.next_case_id AND t1.lawyer_id=t3.lawyer_id AND t2.next_case_date= date_add(CURDATE(),INTERVAL 1 DAY)");
...
if(mysqli_num_rows($propnxtdt) > 0)
  {
    ...
    {  
        ...
        { 
            ...
            $proplisted_lawyerss = mysqli_query($conn,"SELECT lawyer_id,email,phone  from tbl_lawyers where firm_id='".$firmid."' OR lawyer_id='".$firmid."'");
            while($proprowedds=mysqli_fetch_array($proplisted_lawyerss))
             ...
             $props = "SELECT t1.court_name, t1.court_number, t1.case_number, t1.client_name,t2.next_case_date, t3.email, t3.phone, t3.firm_name, t3.lawyer_id, t3.type, t3.firm_id from tbl_cases t1, tbl_case_nextdt t2, tbl_lawyers t3 where t1.case_id=t2.next_case_id AND t1.lawyer_id=t3.lawyer_id AND t2.next_case_date= date_add(CURDATE(),INTERVAL 1 DAY) AND t1.lawyer_id IN ($lawyers_list)";
           ...
           if($proprownxt['firm_id'] == 0 AND $proprownxt['type'] != 'firm')
           {
            ...
            $propsz = "SELECT  t1.court_name, t1.court_number, t1.case_number, t1.client_name,t2.next_case_date, t3.email, t3.phone, t3.firm_name, t3.lawyer_id, t3.type, t3.firm_id from tbl_cases t1, tbl_case_nextdt t2, tbl_lawyers t3 where t1.case_id=t2.next_case_id AND t1.lawyer_id=t3.lawyer_id AND t2.next_case_date= date_add(CURDATE(),INTERVAL 1 DAY) AND t1.lawyer_id = '".$lawyerid."'";
