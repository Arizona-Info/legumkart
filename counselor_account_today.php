<!-- today detail -->
               <div class="tab-pane fade in active" id="today" role="tabpanel">
                 ...
                 <table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
                       ...
                       <?php 
                       $srl =1;
                       $counselcases = mysqli_query($conn,"SELECT t1.*, t2.* FROM tbl_counsel_cases t1, tbl_cases t2 WHERE cc_date = '".date('Y-m-d')."' AND t1.cc_case_id=t2.case_id AND t1.cc_status='Accepted' AND t1.counsel_id = '".$_SESSION['user_id']."'");
                    ...
                    ?>    
                             <tr>
                                      ...
                                      <td><u><a href="#court_detailss<?php echo $srl;?>"  data-toggle="modal" title="View Lawyer/Court Details"><?php echo $counsellawyerrow['firm_name'];?></a></u></td>


                   <td>
                   
                      <?php if($counselcasesrow['cc_type'] == 'Conference'){?>
                        <u><a href="#conselordetail<?php echo $srl;?>"  data-toggle="modal" title="View Conference Place"><?php echo $counselcasesrow['cc_type'];?></a></u>
              ...
              <?php if($counselcasesrow['cc_type'] == 'Conference'){ ?>
                ...
                <td>
                 ...
                 <td>
                   <?php if($counselcasesrow['cc_bill_pdf'] == ""){ ?>
                    <u><a href="#conselordetail52<?php echo $srl;?>"  data-toggle="modal" title="Court Details" <?php if($row['cc_action']=="Not Attended") { echo 'style="display: none;"'; } ?> id="visible_<?php echo $counselcasesrow['cc_id'];?>">Generate Bill</a></u>
                       ...
                       <div class="modal-dialog">
                          <div class="modal-content">
                             ...
                             <div class="modal-body">
                                ...
                                <form id="bill_generate_form<?php echo $srl;?>" method="post" action="" autocomplete="off">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <input class="form-control" id="val_2<?php echo $srl;?>" type="text" name="amt_2" value="" placeholder="GMS" oninput="add2(<?php echo $srl;?>)" required>
                            </div>
                          </div>
                          <div class="col-md-6" hidden>
                            <div class="form-group">
                              <!-- <label>Amount_1 :</label> -->
                              <input class="form-control" id="val_1<?php echo $srl;?>" type="text" name="amt_1" value="15" placeholder="Amount" oninput="add1(<?php echo $srl;?>)" required >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <input class="form-control" id="val_3<?php echo $srl;?>" type="text" name="amt_3" value="" placeholder="Total" readonly required>
                            </div>
                          </div>
                          <div class="col-md-12">
                          <div class="form-group">
                            <button type="button" class="btn btn-simple " onClick="bill_generate_btn(<?php echo $srl;?>)">Generate</button>
                        </div>
                        </div>
                                </form>
